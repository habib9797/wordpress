...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210424_medteach_f0fa2dac5900583d5642_20210424111747_archive.zip';
	const ARCHIVE_SIZE		 = '71031903';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f0fa2da-24111747';
    const SECONDARY_PACKAGE_HASH = '69ebce1-24111747';
	const VERSION			 = '1.4.0';
